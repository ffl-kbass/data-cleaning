      ...
      <ul className={styles.container}>
        <li className={styles.item}>
          ...
          {!loading ? (
            <p
              ...
              title={data.district.items.entity_name}
            >
              {data.district.items.entity_name}
            </p>
          ) : (
            <Skeleton />
          )}
        ...
        <li className={styles.item}>
          ...
          {!loading ? (
            <p className={styles.content}>
              {data.district.items.entity_number}
            </p>
          ) : (
            <Skeleton />
          )}
        ...
        <li className={styles.item}>
          ...
          {!loading ? (
            <p
              className={styles.content}
              title={data.district.items.child_entity_numbers}
            >
              {data.district.items.child_entity_numbers &&
                JSON.parse(`[${data.district.items.child_entity_numbers}]`)
                  .length}
            </p>
          ) : (
            <Skeleton />
        ...
        <li className={styles.item}>
          ...
          {!loading ? (
            <p className={styles.content}>
              {data.district.items.total_bandwidth_mbps} Mbps
            </p>
          ) : (
            <Skeleton />
          )}
        ...
        <li className={styles.item}>
          ...
          {!loading ? (
            <p className={styles.content}>
              {data.district.items.bandwidth_per_student_mbps} Mbps
            </p>
          ) : (
            <Skeleton />
          )}
        ...
        <li className={styles.item}>
          ...
          {!loading ? (
            <p className={styles.content}>
              {data.district.items.adj_bandwidth_per_student_mbps} Mbps
            </p>
          ) : (
            <Skeleton />
          )}
        ...
        <li className={styles.item}>
          ...
          {!loading ? (
            <p className={styles.content}>
              ${Number(data.district.items.cost_per_mbps).toFixed(2)}
            </p>
          ) : (
            <Skeleton />
          )}
        ...
        <li className={styles.item}>
          ...
          {!loading ? (
            <p className={styles.content}>
              {data.district.items.in_universe == 1 ? "True" : "False"}
            </p>
          ) : (
            <Skeleton />
          )}
